                        ...
                        <tbody>
                            @foreach($Pejabat as $j)
                                <tr>
                                    ...
                                    @endphp
                                <td>{{ $no++ }}</td>
                                <td>{{ $j->kode_pejabat }}</td>
                                <td>{{ $j->nip }}</td>
                                <td>{{ $j->nama }}</td>
                                <td>{{ $j->jabatan }}</td>
                                    <td class="text-center">
                                        <a href="" class="btn btn-sm btn-primary " >Info</a>
                                    <a href="{{route('pejabat_edit', ['id' => IDCrypt::Encrypt( $j->id)])}}" class="btn btn-sm btn-info " >Edit</a>
                                        <a href="{{route('pejabat_hapus', ['id' => IDCrypt::Encrypt( $j->id)])}}" class="btn btn-sm btn-danger" >Hapus</a>
        ...
        <div class="modal-body">
          ...
          <form  method="post" action="">
            ...
            <div class="form-group">
              <input type="text" name="kode_pejabat"  class="form-control" placeholder="Kode Pejabat"/>
            </div>
            <div class="form-group">
